DEPS = 
CFLAGS += -std=c11 -g -Wall -Wextra -ftrapv -Wshadow -Wundef -Wcast-align -Wunreachable-code -fstack-protector -D_FORTIFY_SOURCE=2
CFLAGS += -O1 -Os
CFLAGS += -I . -I ./include -I ./deps/mem-pool/include

TEST_CFLAGS = $(CFLAGS) -I ./deps/ctest

SRC = $(shell find src -name "*.c") $(shell find ./deps/mem-pool/src -name "*.c")
TEST_SRC = $(shell find test -name "*.c")

TARGET = collections-c
